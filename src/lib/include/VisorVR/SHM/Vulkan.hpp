...
#include <VisorVR/Vulkan/smart-pointers.hpp>

namespace VisorVR::SHM::Vulkan {

using VisorVR::Vulkan::unique_vk;
...
struct InstanceCreateInfo
  : VisorVR::Vulkan::ExtendedCreateInfo<VkInstanceCreateInfo> {
  InstanceCreateInfo(const VkInstanceCreateInfo& base);
};

struct DeviceCreateInfo
  : VisorVR::Vulkan::ExtendedCreateInfo<VkDeviceCreateInfo> {
...
class Reader final : public SHM::Reader {
 ...
 private:
  ...
  VisorVR::Vulkan::Dispatch* mVK {nullptr};
