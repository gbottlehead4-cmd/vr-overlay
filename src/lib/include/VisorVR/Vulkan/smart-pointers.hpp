...
#define VISORVR_VK_SMART_POINTER_DEVICE_RESOURCES_CREATE_DESTROY \
  IT(Buffer, ) \
  IT(CommandPool, ) \
  IT(DescriptorPool, ) \
...
#define VISORVR_VK_SMART_POINTER_DEVICE_RESOURCES \
  VISORVR_VK_SMART_POINTER_DEVICE_RESOURCES_CREATE_DESTROY \
  IT(DeviceMemory, )

#define VISORVR_VK_SMART_POINTER_INSTANCE_RESOURCES \
  IT(DebugUtilsMessenger, EXT)

#define VISORVR_VK_SMART_POINTER_CREATE_DESTROY_RESOURCES \
  VISORVR_VK_SMART_POINTER_DEVICE_RESOURCES_CREATE_DESTROY \
  VISORVR_VK_SMART_POINTER_INSTANCE_RESOURCES
